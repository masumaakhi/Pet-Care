...
const pets = [
  ...
  },
  {
    ...
    gender: "Male",
    image:
      "https://images.pexels.com/photos/ lying-cat.jpeg?auto=compress&cs=tinysrgb&w=800",
    tag: "Indoor & Playful",
  },
  {
    id: 3,
      ...
      >
        <div className="flex items-center gap-3 bg-white/80 backdrop-blur-md border border-[#d0ddcc] rounded-2xl px-4 py-2.5 shadow-sm">
          ...
          <div className="flex gap-2 flex-wrap text-xs">
            <span className="px-3 py-1 rounded-full bg-[#e4efe0] text-[#2f3e2c]">
              Dogs
            </span>
            <span className="px-3 py-1 rounded-full bg-[#f1e9dd] text-[#5a452f]">
              Cats
            </span>
            <span className="px-3 py-1 rounded-full bg-[#e2f3f1] text-[#28534c]">
              Puppies / Kittens
            </span>
          </div>
        </div>
